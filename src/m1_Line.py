...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        start = Point.plus(self.start,other_line.start)
        end = Point.plus(self.end, other_line.end)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        start = Point.minus(self.start, other_line.start)
        end = Point.minus(self.end, other_line.end)
        return Line(start, end)
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        midpoint = Point.halfway_to(self.start, self.end)
        return midpoint
    ...
    def is_parallel(self, line2):
        ...
        ################################################################
        s = round(self.slope(), 12)
        l = round(line2.slope(), 12)
        if s == l:
            return True
        else:
            return False
